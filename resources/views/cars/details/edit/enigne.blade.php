        ...
        <div class="col-lg-2 col-md-6 col-sm-12">
            <div class="mb-3">
                ...
                <input type="text" id="chassis_number" name="chassis_number" class="form-control"
                    value="{{ $carDetail->chassis_number ?? '-' }}">
            </div>
        </div>
        ...
        <div class="col-lg-2 col-md-6 col-sm-12">
            <div class="mb-3 mt-3">
                ...
                <input type="number" id="owner" name="owner" class="form-control" placeholder="1" min="0"
                    value="{{ $carDetail->getCarDetailAccident->owner ?? '-' }}">
            </div>
        </div>
        ...
        <div class="col-lg-2 col-md-6 col-sm-12">
            <div class="mb-3 mt-3">
                ...
                <select id="usage" name="usage" class="form-control select2-ajax select2-url"
                    ...
                    data-selected-id="{{ $carDetail->getCarDetailAccident->getUsage->id ?? '' }}"
                    data-selected-text="{{ $carDetail->getCarDetailAccident->getUsage->name ?? '' }}">
                </select>
            </div>
        </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="mb-3 mt-3">
                        ...
                        <select id="manufacturers_warranty" name="manufacturers_warranty"
                            ...
                            data-selected-id="{{ $carDetail->getCarDetailAccident->getManufacturersWarranty->id ?? '' }}"
                            data-selected-text="{{ $carDetail->getCarDetailAccident->getManufacturersWarranty->name ?? '' }}">
                        </select>
                    </div>
                </div>
                <!-- CARGURU's Warranty -->
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="mb-3 mt-3">
                        ...
                        <select id="cargurus_warranty" name="cargurus_warranty"
                            ...
                            data-selected-id="{{ $carDetail->getCarDetailAccident->getcargurus_warranty->id ?? '' }}"
                            data-selected-text="{{ $carDetail->getCarDetailAccident->getcargurus_warranty->name ?? '' }}">
                        </select>
                    </div>
                </div>
            </div>
    ...
    <div class="row g-3">
        ...
        <div class="col-12 col-lg-4">
            ...
            <textarea id="inspector_feedback_comment" name="inspector_feedback_comment" class="form-control" rows="6"
                placeholder="Enter Car Description">{{ old('inspector_feedback_comment', $carDetail->getCarDetailAccident->inspector_feedback_comment ?? '-') }}</textarea>
        </div>
        ...
        <div class="col-12 col-lg-4">
            ...
            <div class="mb-2">
                <input id="carguru_spotlight_header_copy" name="carguru_spotlight_header_copy" type="text"
                    ...
                    value="{{ $carDetail->getCarDetailAccident->carguru_spotlight_header_copy ?? '-' }}">
            </div>

            <div class="mb-3">
                <textarea id="carguru_spotlight_body_copy" name="carguru_spotlight_body_copy" class="form-control"
                    rows="4"
                    placeholder="Enter Body Copy">{{ old('carguru_spotlight_body_copy', $carDetail->getCarDetailAccident->inspector_feedback_comment ?? '-') }}</textarea>
            </div>
        </div>
    </div>
</div>
