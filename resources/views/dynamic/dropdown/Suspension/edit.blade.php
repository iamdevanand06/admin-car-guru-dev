...
@section('content')
    <div class="page-wrapper">
        <div class="content">
            <div class="page-header">
                <div class="add-item d-flex">
                    <div class="page-title">
                        <h4 class="fw-bold">Update Make Suspensio</h4>
            ...
            <form method="POST" action="{{ route('make_suspension.update', $make_suspension->id) }}"
                                        ...
                                        <div class="col-sm-6 col-12">
                                            <div class="mb-3">
                                                ...
                                                <select class="select" name="status" id="status">
                                                    <option value="1" {{ $make_suspension->status == 1 ? 'selected' : '' }}>
                                                        Active
                                                    </option>
                                                    <option value="0" {{ $make_suspension->status == 0 ? 'selected' : '' }}>
                                                        In-Active
                                                    </option>
                                                </select>
                                            </div>
